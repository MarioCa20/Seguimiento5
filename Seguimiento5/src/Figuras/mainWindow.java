...
public class mainWindow extends JFrame implements ActionListener {
    ...
    */
    public mainWindow(){
        inicio();
        setTitle("Figura"); // Establece el título de la ventana
    ...
    */
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == esfera) { // Si se pulsa el botón esfera
            WindowEsfera esfera = new WindowEsfera(); /* Crea la
        ...
        if (evento.getSource() == cilindro) { /* Si se pulsa el botón
            cilindro */
            WindowCilindro cilindro = new WindowCilindro(); /* Crea la
        ...
        if (evento.getSource() == pirámide) { /* Si se pulsa el botón
            pirámide */
            WindowPiramide pirámide = new WindowPiramide(); /* Crea
